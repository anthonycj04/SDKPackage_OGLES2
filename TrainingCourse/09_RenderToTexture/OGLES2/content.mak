...
YellowWood.pvr: $(MEDIAPATH)/YellowWood.png
	$(PVRTEXTOOL) -pvrtcfast -m -fOGLPVRTC2 -i$(MEDIAPATH)/YellowWood.png -o$@
...
$(CONTENTDIR)/RenderToTexture.cpp: RenderToTexture.pod
	$(FILEWRAP)  -o $@ RenderToTexture.pod

$(CONTENTDIR)/YellowWood.cpp: YellowWood.pvr
